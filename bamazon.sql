...
INSERT INTO products(product_name, department_name, price, stock_quantity)
    ...
    ("Aquarium tank (medium)", "pet supplies", 79.99, 12),
    ("Sherpa throw (maroon)", "home and kitchen", 16.49, 20),
    ("Raccoon chew toy", "pet supplies", 14.98, 6),
    ("Printer paper (500 sheets)", "office supplies", 8.99, 9),
    ("Sharpie pens (variety pack)", "office supplies", 10.99, 21),
    ("Micro USB cable", "electronics", 4.99, 97),
    ("Gloomhaven", "toys and games", 139.99, 4),
    ("Throw pillows", "home and kitchen", 12.99, 34),
